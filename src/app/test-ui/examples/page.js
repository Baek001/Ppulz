...
const MOCK_CARDS = [
    ...
    { card_id: '3', card_type: 'bill', big_category: '정치/행정', sub_category: '국회/정당', title: '전세사기 피해자 지원 특별법 개정안 발의', description: '피해자 인정 범위를 확대하고 지원책을 강화하는 내용을 담고 있다.' },
    ...
    { card_id: '5', card_type: 'news', big_category: '사회/노동', sub_category: '인권/복지', title: '저출산 대책, 현금 지원 확대 효과 있을까', description: '전문가들은 현금 지원보다는 일·가정 양립 환경 조성이 시급하다고 지적한다.' },
